...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -J Quality_Trim_c_5-%A_%a.out
#SBATCH -D /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Scripts/Quality_Trim
#SBATCH -o /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Logs/Quality_Trim/Quality_Trim_c_5.%A_%a.out
#SBATCH -e /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Logs/Quality_Trim/Quality_Trim_c_5.%A_%a.error
...
--too-short-output ${OUT_PATH}/short_${EXP}_5T_R1.fastq \
--too-short-paired-output ${OUT_PATH}/short_${EXP}_5T_R2.fastq \
-g file:${PRIMER_PATH}/primers_${EXON}_fw_5.fasta \
-G file:${PRIMER_PATH}/primers_${EXON}_rev_5.fasta \
-o ${OUT_PATH}/${EXP}_5T_R1.fastq \
-p ${OUT_PATH}/${EXP}_5T_R2.fastq \
${IN_PATH}/${EXP}_R1.fastq \
${IN_PATH}/${EXP}_R2.fastq

echo "${N}:${EXP}" >> ${LOG_PATH}/index_c.txt
