...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -J Quality_Trim_g_3-%A_%a.out
#SBATCH -D /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Scripts/Quality_Trim
#SBATCH -o /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Logs/Quality_Trim/Quality_Trim_g_3.%A_%a.out
#SBATCH -e /home/groups/song/songlab2/alanluu2/CRISPR-SKIP_AG/Logs/Quality_Trim/Quality_Trim_g_3.%A_%a.error
...
FILE_ARR=($(ls $IN_PATH/*_g_*.fastq | xargs -n 1 basename | sed 's/_5T_R[1,2].fastq//g' | uniq))
...
-a file:${PRIMER_PATH}/primers_gDNA_fw_3.fasta \
-A file:${PRIMER_PATH}/primers_gDNA_rev_3.fasta \
-o ${OUT_PATH}/${EXP}_53T_R1.fastq \
-p ${OUT_PATH}/${EXP}_53T_R2.fastq \
${IN_PATH}/${EXP}_5T_R1.fastq \
${IN_PATH}/${EXP}_5T_R2.fastq

echo "${N}:${EXP}" >> ${LOG_PATH}/index_g.txt
